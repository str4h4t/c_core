...
data_1 = np.asarray(data_set_1.iloc[:, 3:])
...
print(ctr_ma)
print(ctr_mi)
pd.DataFrame(macro_pairs).to_csv('vodafone_raw_0.8_0.8_macro_data_pairs_port_lvl_5000_0921.csv')
pd.DataFrame(micro_pairs).to_csv('vodafone_raw_0.8_0.8_micro_data_pairs_port_lvl_5000_0921.csv')
pd.DataFrame(predicted_pairs_dcca).to_csv('vodafone_raw_0.8_0.8_0.8_dcca_port_lvl_5000_0921.csv')
pd.DataFrame(predicted_pairs_pearson).to_csv('vodafone_raw_0.8_0.8_0.8_pearson_port_lvl_5000_0921.csv')
pd.DataFrame(predicted_pairs_spearman).to_csv('vodafone_raw_0.8_0.8_0.8_spearman_port_lvl_5000_0921.csv')
pd.DataFrame(predicted_pairs_kendall).to_csv('vodafone_raw_0.8_0.8_0.8_kendall_port_lvl_5000_0921.csv')
print("done")
