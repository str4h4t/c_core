...
for p in param:
    cor_mat += np.load('kshape_cor_matrix_cross_osids_vodafone_raw_data_a_'+ p +'.npy')
cor_mat = cor_mat/4
results = []
...
pd.DataFrame(results).to_csv('cross_osid_mar19_filtered_raw_data_kshape_a_combined_result.csv')
print("done")
